...
//   //add that item/div to the html list
  ...
  if(currentStep == 1){
    ...
    Newitem.innerText = "test" //document.forms[0][page1data1] //set text in that div
    Newitem.classList.add("page2show1-item")    //adds the div to that class
  }
...
submitButton.addEventListener('click', (event) => {
  ...
  //step3
   ...
   //convert base64 to hash using key
   let encryptionKey = page2data1.value
   let hash = base64ToEncryption(base64String, encryptionKey)
